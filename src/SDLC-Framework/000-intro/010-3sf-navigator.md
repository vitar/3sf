...
| :--- | :--- | :--- | :--- |
| **“We need to define the project’s rules of engagement.”** | Discover / Setup | [**Engagement Context Canvas**](../200-practice/210-engagement-context-canvas.md) | *Context before Method* |
| **“We need to set the boundaries for approval authority.”** | Shape / Governance | [**Autonomy & Control Boundary Charter**](../200-practice/220-autonomy-control-charter.md) | *Trust before Control* |
| **“We need to define what success looks like.”** | Discover / Shape | [**Outcome-to-Accountability Map**](../200-practice/215-outcome-accountability-map.md) | *Outcome before Output* |
...
| **“I need to prepare a report on partnership health.”** | Run / Evolve | [**Maturity Dashboard & Metrics Consolidation**](../200-practice/265-maturity-dashboard.md) | *Visibility Builds Trust* |
| **“We want to learn from delivery issues without blaming.”** | Evolve / Reflect | [**Learning Before Blame Protocol**](../200-practice/270-learning-before-blame-protocol.md) | *Learning before Blame* |

## 2. Quick Reference by SDLC Stage

### **Discover**

- [Engagement Context Canvas](../200-practice/210-engagement-context-canvas.md) — align on environment and rules of engagement.
- [Outcome-to-Accountability Map](../200-practice/215-outcome-accountability-map.md) — define measurable success.

### **Shape**

- [Autonomy & Control Boundary Charter](../200-practice/220-autonomy-control-charter.md) — define decision-making rights.
...
- [Learning Before Blame Protocol](../200-practice/270-learning-before-blame-protocol.md) — conduct constructive retrospectives.
- [Maturity Dashboard & Metrics Consolidation](../200-practice/265-maturity-dashboard.md) — visualize maturity trends.

## 3. When in Doubt

Start with one of these entry points:

- **If your project hasn’t started:** use the [Engagement Context Canvas](../200-practice/210-engagement-context-canvas.md).
