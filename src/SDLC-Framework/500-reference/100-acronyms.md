...
| ADR | Architecture Decision Records | Structured records that capture and share significant architecture decisions and their rationale. |
...
| CIOs | Continuous Improvement Objectives | Roadmap-aligned improvement goals that embed evolution work into operations. |
| CRC | Contextual Rules Catalog | Catalog translating Stable Rules into context-specific delivery playbooks. |
| DMI | Delivery Maturity Index | Dashboard metric reflecting average delivery maturity adjusted by predictability and flow. |
...
| EMI | Engagement Maturity Index | Dashboard metric showing the average engagement-line maturity across active projects. |
...
| MTTD | Mean Time to Detect | Operations metric measuring how quickly incidents are discovered. |
| MTTR | Mean Time to Recover | Recovery metric measuring how long it takes to restore service after an incident. |
| MV | Maturity Velocity | Rate of maturity score improvement tracked per quarter. |
...
| SRR | Systemic Risk Ratio | Dashboard signal indicating the share of projects with declining maturity trends. |
| VMI | Value Maturity Index | Metric showing how many delivered outputs link to measurable outcomes. |
